...
import { TIMING_OPTIONS, INSTRUCTION_OPTIONS } from '../constants';
...
const MedicineInputRow: React.FC<MedicineInputRowProps> = ({
  ...
  if (isPdfMode) {
    return (
      <div className="grid grid-cols-12 gap-4 items-center text-slate-800">
        <div className="col-span-4">{medicine.name}</div>
        <div className="col-span-2">{medicine.quantity}</div>
        <div className="col-span-3">{medicine.timing}</div>
